...
./src/word_butcher.c ./src/get_words_count.c ./src/check_quotes.c ./src/word_split.c ./src/parser.c ./src/find_cmd.c \
./src/parser_utils.c ./src/update_tokens.c ./src/find_args.c ./src/find_redirs.c ./src/add_group.c ./src/add_group_utils.c \
